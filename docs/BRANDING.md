...
يحافظ شعار الخادم على حرف باء `ب` ونقطته من هوية لغة باء، ويضيف ثلاث عقد
اتصال ترمز إلى الربط القياسي بين المحرر والخادم والمصرف. لا يحتوي الشعار
نصًا لاتينيًا.
...
- `assets/branding/BaaLspLogo-chroma-v1.png`: مصدر التوليد المحفوظ للتتبع.

## طريقة الإنشاء

استُخدم شعار باء الحالي مرجعًا بصريًا داخل أداة توليد الصور المدمجة. طلب
